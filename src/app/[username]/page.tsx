  ...
  return (
    <div>
      <div className="flex items-center gap-8 sticky top-0 backdrop-blur-md p-4 z-10 bg-[#00000084]">
        ...
        <h1 className="font-bold text-lg">Dev Anslem</h1>
      </div>
      {/* INFO */}
      <div>
        ...
        <div className="p-4 flex flex-col gap-2">
          <div className="">
            <h1 className="text-2xl font-bold">Dev Anslem</h1>
            <span className="text-textGray text-sm">@AnslemWebDev</span>
          </div>
          <p>Trying to be the best developer possible</p>
