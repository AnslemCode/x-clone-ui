...
const Post = async ({ type }: { type?: "comment" | "status" }) => {
      ...
      <div className={`flex gap-4 ${type === "status" && "flex-col"}`}>
        ...
        <div className="flex-1 flex flex-col gap-2">
          ...
          <div className="w-full flex justify-between">
            <Link href={`/AnslemCodes`} className="flex gap-4">
              <div
                className={`${
                  type !== "status" && "hidden"
              ...
              >
                <h1 className="text-md font-bold">AnslemCodes</h1>
                <span
          ...
          {/* TEXT and MEDIA */}
          <Link href={`/AnslemCodes/status/123`}>
